...
工作名稱: <input name="name" type="text" value="<?php echo $rs['jobName'];?>" disabled="disabled"/> <br>

緊急程度: <select name="urgent" disabled="disabled">
...
工作說明: <textarea name='content' disabled="disabled"><?php echo $rs['jobContent'];?></textarea><br>
確定刪除此筆待辦事項嗎？<br>
<!-- <input type="submit" name="Submit" value="送出" /> -->
<input type='button' onClick="deleteForm()" value="delete">
<input type='button' onClick="loadURL('2.list.php')" value="back">
