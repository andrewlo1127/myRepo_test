...
if ($id <=0) {
	...
	$sql = "select jobName, jobUrgent, jobContent, jobComplete from todo where id=?;"; 
...
<input type="checkbox" name='complete' value='1' <?php if ($rs['jobComplete'] == 1) echo 'checked'; ?>>完成<br>
<!-- <input type="submit" name="Submit" value="送出" /> -->
<input type='button' onClick="updateForm()" value="save">
